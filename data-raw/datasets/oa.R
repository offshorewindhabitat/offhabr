...
# TODO: average OceanAdapt regions across seasons

sort(oa_rgns$oa_region)
# "Northeast US": "Northeast US Fall", "Northeast US Spring"
# "Southeast US": "Southeast US Fall", "Southeast US Spring", "Southeast US Summer"

# add OceanAdapt regions to data in package ----
oa_regions <- read_sf(oa_rgns_geo)
oa_regions %>% colnames() %>% paste(collapse = "}{}\n#'   \\item{") %>% cat()
usethis::use_data(oa_regions)
